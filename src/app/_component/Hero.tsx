        ...
        <div className="relative bg-black w-full h-full rounded-3xl overflow-hidden">
          <motion.div style={{ x, y }}>
            <Image
              ...
              className="w-full max-md:h-screen max-md:object-cover max-md:scale-150 scale-105"
            />
          </motion.div>
          <div className="absolute left-7 top-7 text-7xl text-white max-lg:text-5xl max-md:text-4xl max-sm:text-3xl">
