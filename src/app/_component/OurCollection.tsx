...
export default function OurCollection() {
  return (
    <section className="py-16 max-md:py-7 sm:px-8 md:px-12 bg-white">
      ...
      <p className="text-lg md:text-xl opacity-60 text-center mb-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 grid-rows-3 md:grid-rows-2 gap-6 h-auto sm:h-[600px]">
        ...
        <motion.div
          ...
          className="sm:row-span-2 relative overflow-hidden rounded-3xl h-72 sm:h-auto group"
        >
          <img
        ...
        <motion.div
          ...
          className="relative overflow-hidden rounded-3xl h-72 sm:h-auto group"
        >
          <img
